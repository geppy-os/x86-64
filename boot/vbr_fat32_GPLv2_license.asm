...
VBR:
    ...
    bpb_SectPerClust	db 1
    bpb_ReservedSect	dw 32
    bpb_FATsCnt 	db 2
    bpb_RootSize	dw 0
    ...
    bpb_TrackSect	dw $3f
    bpb_Heads		dw $ff
    bpb_hiddenSect	dd $7d82

    bpb_TotalSect	dd $139C5
    bpb_fatSz		dd $26a
    bpb_extFlags	dw 0
    bpb_ver		dw 0
    bpb_rootClust	dd 2
...
@@:
    ...
    jmp     0:@f			; flush CS
align 4 				; not really sure what alignment is for, might be for performace++
...
fileNotFound: db "12345678.bin missing"
...
readDisk:
    push    ebx 			; Bochs 2.51 STILL messes with top 16bit for some registers
    mov     byte [si+32], 1
    shl     byte [si+32], cl
.read:
    sti
